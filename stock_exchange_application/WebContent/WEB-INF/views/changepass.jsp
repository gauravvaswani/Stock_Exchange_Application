...
<body>
	...
	<div class="col-md-12 body-wrap">
		<div class="container">
			<div class="row">
				<div class="col-sm-6" style="padding:64px;">
				
							<h3 style="font-variant:small-caps;">Change Password</h3>
						<form name="myForm" action="changepass.html" method="post">
							<br/>
								<div class="col-sm-8">
								<label class="sr-only mr-sm-2" for="customerConfirmPwd">Old Password</label>
								<div class="input-group mb-5 mb-sm-0">
									<div class="input-group-addon form-control-sm"><i class="material-icons">vpn_key</i></div>
									<input type="password" maxlength="15" ng-model="formData.password_c" class="form-control form-control-sm" id="customerConfirmPwd" name="passwordOld" valid-password-c="formData.password" required size="65" placeholder="Old Password">
							...
							<div class="col-sm-8">
								<label class="sr-only mr-sm-2" for="customerPwd">New Password</label>
								<div class="input-group mb-5 mb-sm-0">
									<div class="input-group-addon form-control-sm"><i class="material-icons">vpn_key</i></div>
									<input type="password" class="form-control form-control-sm" id="customerPwd" placeholder="New Password" maxlength="12" name="passwordNew" ng-model="formData.password" required size="65" ng-maxlength="20" ng-minlength="6" ng-pattern="/(?=.*[a-z])(?=.*[A-Z])(?=.*[^a-zA-Z])/" autofocus>
							<br>                          
									  ...
									  <p ng-show="myForm.password.$error.minlength" class="error"> &nbsp&nbsp  Passwords must be between 6 and 12 characters.</p>
                                          
                                        <p ng-show="myForm.password.$error.pattern" class="error"> &nbsp&nbsp  Must contain one lower &amp; uppercase letter, and one non-alpha character &nbsp&nbsp(a number or a symbol.)</p>
