	...
	<body>
		...
		<div class="col-md-12 body-wrap">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<h1 style="font-variant:small-caps;">Watchlist</h1>
						<hr>
					</div>
				</div>
				<div class="row">
						...
						<table data-toggle="table"  data-pagination="true" data-side-pagination="client" data-page-list="[5, 10, 20, 50, 100, 200]" data-search="true" >
							<thead>
								<tr>
									...
									<!-- th data-field="highest_stock_value" data-sortable="true" data-align="center">High Value</th>
									<th data-field="lowest_stock_value" data-sortable="true" data-align="center">Low Value</th-->
									<th data-field="opening_stock_value" data-sortable="true" data-align="center">Opening Value</th>
									<th data-field="closing_stock_value" data-sortable="true" data-align="center">Closing Value</th>
									<th data-field="last_trade_price" data-sortable="true" data-align="center">Last Trade Price</th>
									<th data-field="volume" data-sortable="true" data-align="center">Volume</th>
									<th data-field="change_percentage" data-sortable="true" data-align="center">Change Percentage</th>
									<th data-field="action" data-sortable="true" data-align="center">Action</th>
								</tr>
							</thead>
							<tbody>
						
							 <c:forEach items="${data}" var="watch" >
								<tr>
									
									<td data-field="company_name" data-align="left"><c:out value="${watch.getStockData().getCompanyData().getCompanyName()}"></c:out></td>
									<td data-field="market" data-align="justify"><c:out value="${watch.getStockData().market}"></c:out></td>
									<!--  td data-field="highest_stock_value" data-align="justify"><c:out value="${watch.getStockData().getHighestStockValue()}"></c:out></td>
									<td data-field="lowest_stock_value" data-align="justify"><c:out value="${watch.getStockData().getLowestStockValue()}"></c:out></td> -->
									<td data-field="opening_stock_value" data-align="justify"><c:out value="${watch.getStockData().getOpeningStockValue()}"></c:out></td>
									<td data-field="closing_stock_value" data-align="justify"><c:out value="${watch.getStockData().getClosingStockValue()}"></c:out></td>
									<td data-field="last_trade_price" data-align="justify"><c:out value="${watch.getStockData().getLastTradePrice()}"></c:out></td>
									<td data-field="volume" data-align="justify"><c:out value="${watch.getStockData().getVolume()}"></c:out></td>
									<td data-field="change_percentage" data-align="justify"><c:out value="${watch.getStockData().getChangePercentage()}"></c:out></td>
									<td data-field="current_value" data-align="justify">
										<a href="deletewatch.html?id=${watch.getWatchlistId()}" style="color:#000;" title="Delete Stock"><i class="material-icons">delete_forever</i></a>
									</td>
